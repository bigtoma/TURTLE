...
class Main_Activity3 : Activity(), RecordAnimationListener {
    ...
    var isPause = true
    val data3 = arrayListOf<MusicList>()
    // 播放列表

    var musicUrl = ""
    var playIndex = -1
    var bgimag = "http://music-mingxiang.oss-cn-hangzhou.aliyuncs.com/%E5%86%A5%E6%83%B3%E9%9F%B3%E4%B9%90-%E7%AB%96%E5%B1%8F.jpg"
    var recordimg ="http://music-mingxiang.oss-cn-hangzhou.aliyuncs.com/%E5%86%A5%E6%83%B3%E9%9F%B3%E4%B9%90-%E8%BD%AC.jpg"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        data3.run {
            add(MusicList(
                    "Dan Gibson - Saffron Morning",
                    bgimag,
                    recordimg,
                    "http://music-mingxiang.oss-cn-hangzhou.aliyuncs.com/Dan%20Gibson%20-%20Saffron%20Morning.mp3"

            ))
            add(MusicList(
                    "Goodall - Candle in the Dark",
                    bgimag,
                    recordimg,
                    "http://music-mingxiang.oss-cn-hangzhou.aliyuncs.com/Goodall%20-%20Candle%20in%20the%20Dark.mp3"
            ))
            add(MusicList(
                    "风潮唱片 - 感谢",
                    bgimag,
                    recordimg,
                    "http://music-mingxiang.oss-cn-hangzhou.aliyuncs.com/%E9%A3%8E%E6%BD%AE%E5%94%B1%E7%89%87%20-%20%E5%85%B1%E4%BA%AB.mp3"
            ...
            add(MusicList(
                    ...
                    bgimag,
                    recordimg,
                    "http://music-mingxiang.oss-cn-hangzhou.aliyuncs.com/%E9%A3%8E%E6%BD%AE%E5%94%B1%E7%89%87%20-%20%E6%84%9F%E8%B0%A2.mp3"
    ...
    fun setListener(){
        ...
        programPlayNext.setOnClickListener {
            ...
            if(playIndex == data3.size.minus(1)){
                playIndex = -1
            }
