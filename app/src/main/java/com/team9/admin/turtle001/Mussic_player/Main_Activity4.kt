...
class Main_Activity4 : Activity(), RecordAnimationListener {
    ...
    val data4 = arrayListOf<MusicList>()
    // 播放列表
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        data4.run {
            add(MusicList(
                    "睡前肌肉渐进放松",
                    "http://songlist-turtle.oss-cn-hangzhou.aliyuncs.com/%E7%9D%A1%E5%89%8D%E5%86%A5%E6%83%B3-%E7%AB%96%E5%B1%8F.jpg",
                    "http://songlist-turtle.oss-cn-hangzhou.aliyuncs.com/TIM%E5%9B%BE%E7%89%8720180911205432.png",
                    "https://www.wocloud.com.cn/webclient/shared-files/download?filename=%E7%9D%A1%E5%89%8D%E8%82%8C%E8%82%89%E6%B8%90%E8%BF%9B%E6%94%BE%E6%9D%BE.mp3&key=_zK6ySqfPWPH5VXReNA657TFUKrQ2PQHyfdjRyzsJt0Xtw1ph3eR_q9itbDRsTwGcUhiSJ_9DuKr1jD323u9Bz5MKp8WGXwR"
            ))
        }
        init()
    }
    ...
    fun setListener(){
        ...
        programPlayNext.setOnClickListener {
            // 播放到最后一首歌时，下标移动到第一首
            if(playIndex == 0){ playPause() }
            if(playIndex == data4.size.minus(1)){
                playIndex = -1
            }
